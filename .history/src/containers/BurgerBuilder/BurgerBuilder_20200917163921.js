  ...
  */
  ...
  const purchaseHandler = () => {
    ...
    if (isAuth) {
      ...
      onSetAuthRedirectPathBB("/checkoutt"); //--> u Auth.js-u je authRedirect u returnu. building je u BBreduceru na 
      //ne mozemo kliknuti na button ako nismo bildali. Zelimo da se autentifikujemo pa da idemo na checkout odmah. A  mjestane da opet idemo nazad na bildanje burgera.
