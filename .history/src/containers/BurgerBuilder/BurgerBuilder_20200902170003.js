...
const BurgerBuilder = (props) => {
  const [porucljivo, setPorucljivo] = useState(false);
...
to cemo za sada zakomentarisati i poslije se nekad vratiti na to. Sad za sad cemu reduceru state-u postaviti. */
  ...
  for (let key in lessButtonsEnability) {
    lessButtonsEnability[key] = lessButtonsEnability[key] <= 0; //ako je {salad: 0} onda ce biti {salad:true, meat: false...}, bit ce dakle disabled
