...
const BurgerBuilder = (props) => {
  ...
  const ings = useSelector((state) => state.burgerBuilderR.ingredients);
  ...
  const purchaseHandler = () => {
    ...
    if (isAuth) {
      ...
      history.push("/auth"); //logicno zelimo da se autentifikujemo da bismo mogli poruciti
  ...
  const lessButtonsEnability = {
    ...props.ings, //lessButtonsEnability = {kecap: 0, salad: 0, bacon: 0, cheese: 0, meat: 0}
  };
