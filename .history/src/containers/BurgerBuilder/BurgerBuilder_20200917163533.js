...
const BurgerBuilder = (props) => {
  ...
  */
  ...
  //const path = building ? "/checkoutt" : "/";
  //zahvaljuci pathu i buildingu njemu ne mozemo da odemo na checkout prazni
  const purchaseHandler = () => {
    ...
    if (isAuth) {
      ...
      onSetAuthRedirectPathBB("/checkoutt"); //path -> objasnjenje iznad
