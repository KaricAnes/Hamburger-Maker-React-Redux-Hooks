...
*/
  ...
  render() {
    ...
    if (!this.props.loading) {
      //debugger;
      orders = this.props.orders.map((order) => ( //id: "-MGASxDVTnjY21vZsKxB"      ingredients: {bacon: 0, cheese: 0, kecap: 0, meat: 0, salad: 1}       orderData: {country: "v", deliveryMethod: "fastest", email: "a.k@gmail.com", name: "a", street: "d", …}       price: 2.5      userId: "QvKFH4q5q8eZKGOdc
        <Order
          key={order.id}
