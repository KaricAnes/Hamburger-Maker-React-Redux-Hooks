...
const initialState = {
  ingredients: null, //{salad: 0, meat:1}
  totalPrice: 2,
  error: false,
  ...
  switch (action.type) {
    ...
    case actionTypes.SET_INGREDIENTS:
      ...
      return {
        ...
        building: false,
         //Ako nisam buildao burger, a otisao sam na auth bit cu bacen nazad na '/'
         //Onda ce building biti true, i ako poslije ponovo pokusam da dodjem na checkout bez bildanja
         //uspjet cu to zato sto je building osato true. 
         //zato je building ovdje bitan da vrati svaki put building na false kada udjemo na BB
      };
