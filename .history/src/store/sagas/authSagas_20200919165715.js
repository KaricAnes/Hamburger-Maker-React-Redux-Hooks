...
//automatic login kada ulazimo na stranicu ali i logout ako je proslo sat vremena od logovanja
...
//automatic logout nakon sat vremena, okida se u authSagi nakon sto se uspjesno ulogujemo
export function* checkAuthTimoutSaga(action) {
  ...
  //A s obzirom da sam ja definisao logout() -> izbrisat cu token iz localStorage i iz Redux-a
}
